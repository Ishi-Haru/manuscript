...
We sincerely thank the reviewer for the positive evaluation of our work and for recommending publication as is. We are grateful for the reviewer’s comment that our manuscript is well written and helps settle long-standing controversies in the field. We respond to the two minor comments below.
...
\begin{itemize}
  ...
  \item Updated the notation from \(f^{*}(b_t, b_s)\) to \(f^{*}(h, b_t, b_s)\) in Eqs. 3, 7, S7, and S8.
\end{itemize}
...
\Changes
\begin{itemize}
  \item Added the representative fitting plots for DLC and nanobubble (Fig. R1(a, b)) as Fig.~\ref{si-figS:DLC_bubble_fit}(a, b) in the Supporting Information.
...
We have also addressed the non-scientific editorial comments where the required correction was unambiguous.

\Changes
\begin{itemize}
  \item \ChangeText{main}{non_sci_keywords_color}{Colored the Keywords text as a revised part.}
  \item \ChangeText{si}{non_sci_figs3_caption}{Corrected the panel combinations in the Fig. S3 caption.}
\end{itemize}
