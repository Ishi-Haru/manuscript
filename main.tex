...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[title]{Hydrophobicity Does Not determine Water Slip Length: Insights from Slip Length Mapping}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\abbreviations{}
\keywords{slip length, boundary slip, AFM, graphite, hydrophobic surface, nanobubble}
...
\ChangeTagStart{non_sci_abstract}\ChangeTagEnd{non_sci_abstract}\section*{Abstract}
...
\section*{Keywords}
\ChangeTagStart{non_sci_keywords}slip length, boundary slip, AFM, graphite, hydrophobic surface, nanobubble\ChangeTagEnd{non_sci_keywords}
