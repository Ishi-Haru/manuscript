...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[title]{Nanoscale Mapping of Intrinsic Slip Length at Solid-Liquid Interfaces}
...
where \(C\) is a proportionality constant. Slip lengths obtained from molecular dynamics (MD) simulations are well fit by Eq.~\ref{eqn:slip length scaling} with \(C = 0.41\), indicating almost no slip even at intrinsic contact angles of \SI{120}{\degree}, which is the near maximum achievable on a topographically smooth flat surface \cite{Nishino1999-dk}. In contrast, when AFM-based experimental slip-length data from various studies are compiled (Figure.~\ref{fgr:previous_slip_length}), they show significant deviation from the MD-predicted scaling law with \(C = 0.41\), with large enhancements of slip lengths on hydrophobic surfaces. Notably, other experimental studies have shown notable deviations from this trend; on hydrophobic surfaces, both nearly no slip \cite{Honig2007-me, Cottin-Bizonne2005-kj} and a slip length as large as \SI{1}{\micro\metre} \cite{Tretheway2002-et} have been detected. 

\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\linewidth]{figs/slip_length_summary/previous_slip_length.png}
  \caption{
    AFM-based experimental slip-length data from previous studies plotted as a function of contact angle.The red dashed line represents the theoretical curve given by Eq.~\ref{eqn:slip length scaling} with $C=0.41$. \cite{Vinogradova2003-gh, Zhang2021-tn, Bhushan2009-yz, Cottin-Bizonne2005-kj, Bonaccurso2002-nf, Honig2007-me, Chen2019-ti, Jing2013-kn, Li2022-qs, Ortiz-Young2013-wc, Maali2008-rd, Han2025-qq, Zhu2011-je, Scarratt2019-yw, Ahmad2015-eb, Bouzigues2008-xn, Cottin-Bizonne2008-nc, Keerthi2021-mz, Lasne2008-qt}
  }
