...
\newcommand{\ReviewerCommentPair}[4]{%
  \par\medskip\noindent
  \begin{quote}\small\color{black}
    \textbf{#1.} #2\par\vspace{0.25\baselineskip}
    \textbf{#3.} #4
  \end{quote}
  \color{blue}
}
\newcommand{\ReviewerCommentTriple}[6]{%
  \par\medskip\noindent
  \begin{quote}\small\color{black}
    \textbf{#1.} #2\par\vspace{0.25\baselineskip}
    \textbf{#3.} #4\par\vspace{0.25\baselineskip}
    \textbf{#5.} #6
  \end{quote}
  \color{blue}
}
...
Thank you for this constructive suggestion. The pristine graphite used in our study had a water contact angle of 59.0°, and we therefore regard it as a hydrophilic surface. On the other hand, as also pointed out by Reviewer 3, interfacial friction (i.e., slip) can be influenced by many factors related to both the solid and the liquid. We cannot rule out the possibility that tuning such factors could enable water slip even on hydrophobic surfaces. Therefore, to emphasize our key finding that wettability itself does not affect the water slip length, as predicted by molecular dynamics simulations, and to better reflect the long-standing controversy regarding slip length on hydrophobic surfaces, we have revised the title to “Hydrophobicity Does Not Affect Water Slip Length: Insights from Slip Length Mapping.” We believe that the revised title is more accurate and appropriate.

\Changes
\begin{itemize}
  \item Revised the manuscript title from ``Water Does Not Slip on Hydrophobic Surfaces: Insights from Slip Length Mapping'' to ``Hydrophobicity Does Not Affect Water Slip Length: Insights from Slip Length Mapping''.
\end{itemize}
...
\ReviewerCommentPair{6}{The authors state that ``We calibrated the slip length of the probe tip by measuring a symmetric system (\(b_t = b_s\)) using an atmospheric-plasma-treated diamond-like carbon (DLC) substrate, yielding a slip length of \(b_t = b_s = 0.0 \pm 1.2\) nm.''}{7}{The authors should show the fit plot for this case, similar to what they did in Figure 2a. Plots should also be shown for the fit used to extract the slip length of 345.3 nm above the nanobubble, as mentioned towards the end of page 8.}
...
\Changes
\begin{itemize}
  \item \ChangeText{main}{r2_12_contact_angle_upper_range_intro}{Revised the main-text statement according to the above discussion for clarity.}
...
Thank you for pointing this out. We have revised the introduction to make the consensus for hydrophilic surfaces clearer. The revised text now states that reported slip lengths on hydrophilic surfaces are generally close to zero in both experimental and simulation studies, as shown in Fig. 1.

% checked

\Changes
\begin{itemize}
  \item \ChangeText{main}{r2_14_slip_consensus}{Clarified the near-no-slip consensus for hydrophilic smooth surfaces.}
\end{itemize}
...
Thank you for raising this important point. We revised the discussion to clarify the origin of the large slip length observed on HOPG. The HOPG surface was cleaved immediately before measurement and showed moderate wettability (\(\SI{59.0}{\degree}\)), close to the value reported for cleaved HOPG by Kozbial et al. (\(\SI{64.4}{\degree}\)). This makes hydrophobic adsorbates unlikely to be the primary origin of the large slip length. We also clarified that the localized nanobubble observed in Fig.~\ref{main-fgr:mapping_results}(b) was analyzed separately and thus did not contribute to the slip length measured on the flat HOPG terrace. HOPG exhibits large slip because its atomically flat and chemically homogeneous crystalline surface forms a low-friction interface with water, as discussed in our response to question 9.

% checked

\Changes
\begin{itemize}
  \item \ChangeText{main}{r2_15_hopg_contact_angle}{Clarified that the measured HOPG contact angle is close to the reported value for cleaved HOPG, that hydrophobic adsorbates are unlikely to be the primary origin of the large HOPG slip length, and that the localized nanobubble was analyzed separately.}
\end{itemize}
...
\ReviewerCommentTriple{1}{The work seems not support the title “Water Does Not Slip on Hydrophobic Surfaces”. The slip effect may be more obvious in the confined water region (such as water in the carbon nanotube), for which the Knudsen number is used to determine its impact.}{2}{In recent work (Nature 2022, 602 (7895), 84– 90), the quantum friction was proposed for the water-carbon interaction. The following work (Nano Lett. 2023, 23 (2), 580– 587; J. Phys. Chem. Lett. 2026, 17(10), 2792-2798) shows the thickness and defect of carbon material also have a significantly impact. All these mean the solid will have influence on the friction, which was not considered in the previous MD simulation.}{3}{The developed experimental method for slip length measurement in present work shows its advantage, however, the conclusion of “Water Does Not Slip on Hydrophobic Surfaces” should be reconsidered, as the friction is influenced by many factors for both solid and liquid.}

We appreciate your thoughtful comments. We agree that interfacial friction can be influenced by many factors. Indeed, if such factors could be appropriately tuned, there remains a possibility that water slip could occur even on hydrophobic surfaces. In this sense, our original title, “Water Does Not Slip on Hydrophobic Surfaces,” was too strong. Our key finding is that, on chemically homogeneous flat surfaces, wettability does not affect the water slip length, thereby experimentally confirming a prediction from molecular dynamics simulations. Therefore, to better reflect our main finding and to emphasize the long-standing controversy regarding slip length on hydrophobic surfaces, we have revised the title to “Hydrophobicity Does Not Affect Water Slip Length: Insights from Slip Length Mapping.” We believe that the revised title more accurately and appropriately reflects our findings.
...
\Changes
\begin{itemize}
  \item Labeled the abstract. (line 1)
\end{itemize}
