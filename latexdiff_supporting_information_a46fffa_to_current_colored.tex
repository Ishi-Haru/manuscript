...
%DIF DEL __latexdiff_old_supporting_information_a46fffa.tex   Sat May  2 03:24:12 2026
%DIF ADD supporting_information.tex                           Sat May  2 03:10:49 2026
%DIF < ﻿%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%DIF -------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %DIF > 
%DIF -------
...
%DIF -------
  Hydrophobicity Does Not determine Water Slip Length: Insights from Slip Length Mapping} %DIF > 
%DIF -------
...
\DIFaddend \begin{figure}[p]
  ...
  \caption{
    \DIFaddFL{Representative damping-coefficient fitting curves for (a) an atmospheric-plasma-treated DLC substrate and (b) a location above a nanobubble.
...
\begin{figure}[p]
  ...
  \caption{(\DIFdelbeginFL \DIFdelFL{a-d}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{a--d}\DIFaddendFL ) Topography and (\DIFdelbeginFL \DIFdelFL{e-h}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{e--h}\DIFaddendFL ) corresponding slip-length maps of (a, \DIFdelbeginFL \DIFdelFL{d}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{e}\DIFaddendFL ) mica, (b, \DIFdelbeginFL \DIFdelFL{e}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{f}\DIFaddendFL ) FDTS, (c, \DIFdelbeginFL \DIFdelFL{f}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{g}\DIFaddendFL ) Teflon, and (d, h) HOPG. The \(R_a\) values were \SI{0.27}{\nano\metre}, \SI{0.29}{\nano\metre}, \SI{0.64}{\nano\metre}, and \SI{0.35}{\nano\metre} for each surface, respectively. Only the result for HOPG (d, h) was obtained in a \SI{10}{\milli\mole\per\litre} KCl solution and the others were in DI water.}
  \label{figS:mapping_colormaps}
\end{figure}
\DIFaddbegin \ChangeTagEnd{non_sci_figs3_caption}
\DIFaddend 

\DIFaddbegin \ChangeTagStart{r2_11_units_comparison_table_si}
\DIFaddend \begin{table}[p]
  \caption{Measured \DIFdelbeginFL \DIFdelFL{contact angles and }\DIFdelendFL slip lengths \DIFdelbeginFL \DIFdelFL{of }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{and values predicted by Eq.~\ref{eqn:slip length scaling} for }\DIFaddendFL the substrates investigated in this study\DIFaddbeginFL \DIFaddFL{.}\DIFaddendFL }
