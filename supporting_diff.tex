...
%DIF DEL tex_diff_tmp\supporting_old_temp.tex   Tue Mar 17 13:38:09 2026
%DIF ADD tex_diff_tmp\supporting_new_temp.tex   Tue Mar 17 13:38:09 2026
...
\begin{equation}
  ...
  \label{eqn:s5}
\end{equation}
Therefore, from Eqs.~\ref{eqn:s4} and \ref{eqn:s5}, \DIFdelbegin \DIFdel{Thus, }\DIFdelend the damping coefficient is related to the amplitude attenuation ratio as follows:
\begin{equation}
...
We compared the sensitivity of slip length measurements between conventional contact-mode AFM and the proposed FM-AFM method. In contact-mode AFM, the cantilever deflection \(x\) is measured as a sensor voltage, and the relationship between the deflection sensor voltage \(V_x\) and \(x\) is expressed using the sensitivity \(s\) as \(x = sV_x\). Furthermore, to determine the viscous drag in Eq.~\ref{eqn:hydrodynamic force} from the restoring force of the cantilever, \(kx\) (\(k\) is the spring constant), the following relation holds:
\begin{equation}
...
\DIFaddendFL \caption{Literature values of contact angle and slip length for various solid-liquid interfaces}
...
\begin{figure}[p]
  \centering
  \DIFaddbeginFL \includegraphics[width=0.6\linewidth]{figs/HOPG_strong_force.png}
  \caption{
    \DIFaddFL{Height image acquired while the tip was strongly pressed against the surface, showing disappearance of the bubble-like feature and exposure of the underlying HOPG substrate.
  }}
...
\begin{figure}[p]
  \centering
  \DIFaddendFL \includegraphics[width=1.0\linewidth]{figs/mapping_colormaps.png}
  \caption{ (\DIFdelbeginFL \DIFdelFL{a-e}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{a-d}\DIFaddendFL ) Topography and (\DIFdelbeginFL \DIFdelFL{f-i}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{e-h}\DIFaddendFL ) corresponding slip-length maps of (a) \DIFdelbeginFL \DIFdelFL{HOPG}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{mica}\DIFaddendFL , (b, \DIFdelbeginFL \DIFdelFL{f}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{e}\DIFaddendFL ) \DIFdelbeginFL \DIFdelFL{mica}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{FDTS}\DIFaddendFL , (c, \DIFdelbeginFL \DIFdelFL{g}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{f}\DIFaddendFL ) \DIFdelbeginFL \DIFdelFL{FDTS}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Teflon}\DIFaddendFL , \DIFaddbeginFL \DIFaddFL{and }\DIFaddendFL (d, h) \DIFdelbeginFL \DIFdelFL{Teflon, and (e, i) }\DIFdelendFL HOPG. The \(R_a\) values were \SI{0.27}{\nano\metre}, \SI{0.29}{\nano\metre}, \SI{0.64}{\nano\metre}, and \SI{0.35}{\nano\metre} for each surface, respectively. \DIFdelbeginFL \DIFdelFL{(a) shows a height image reconstructed from the same dataset as Fig.~\ref{fgr:mapping_results} (a, b). In this case, the surface profile was reconstructed using the data obtained when the tip was pushed until the cantilever deflection corresponded to a force of approximately 100 nN, where the tip is in firm contact with the substrate. }\DIFdelendFL Only the result for HOPG (\DIFdelbeginFL \DIFdelFL{e}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{d}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{i}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{h}\DIFaddendFL ) was obtained in a \SI{10}{\milli\mole\per\litre} KCl solution and the others were in DI water.}
  \label{figS:mapping_colormaps}
\end{figure}

\begin{table}[p]
  \caption{Measured contact angles and slip lengths of the substrates investigated in this study}
