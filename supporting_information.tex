...
\begin{figure}[p]
  ...
  \caption{
    Representative damping-coefficient fitting curves for (a) a atmospheric-plasma-treated DLC substrate and (b) a location above a nanobubble.
...
\begin{table}[p]
  \caption{Measured slip lengths and values calculated from Eq.~\ref{eqn:slip length scaling} for the substrates investigated in this study.}
