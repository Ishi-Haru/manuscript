...
\begin{equation}
  ...
  \label{eqn:s5}
\end{equation}
Therefore, from Eqs.~\ref{eqn:s4} and \ref{eqn:s5}, Thus, the damping coefficient is related to the amplitude attenuation ratio as follows:
\begin{equation}
...
\begin{equation}
  ...
  \label{eqn:s8}
\end{equation}
Here, the measurement sensitivity is defined as the change in signal voltage with respect to thesubstrate slip length, \(\partial V/\partial b_s\). Differentiating Eqs.~\ref{eqn:s7} and \ref{eqn:s8} yields the sensitivities for each method, \(S_{\text{contact}}\) and \(S_{\text{FM}}\):
\begin{equation}
